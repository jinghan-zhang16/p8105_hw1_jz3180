...
The data in the penguins dataset is stored in a tibble, with `r nrow(penguins)` observations (rows) and `r ncol(penguins)` categories/variables (columns) for each observation.
